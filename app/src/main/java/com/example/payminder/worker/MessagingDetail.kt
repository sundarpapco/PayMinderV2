...
@Params
customer - Customer Object to whome this message should be sent. Also, this field has all the data necessary to generate
...
data class MessagingDetail(
    ...
    fun message(context:Context): String {
        return context.getString(R.string.message_template,customer.name,customer.overdueRupees)
    }
}